...
<p>This test about the use of the C++ programming language is similar to the classic <i>'Hello World'</i> program for testing the correctness of the building infrastructure. In this case, the <i>'puts()'</i> C library function is exploited.</p>
<p><hr></p>
...
<p>
	As mentioned above, the <i>'Example-002'</i> executable file is created. For instance, this test is executed by running:
</p>
<pre>./Example-002</pre>
<p>
