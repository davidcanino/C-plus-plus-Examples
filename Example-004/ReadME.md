...
<p>This basic test about the use of the C++ programming language performs several implicit initializations of an array, and the efficient traversal of an array by using an <i>'automatic'</i> variable. These C++ statements were introduced for the first time by the C++11 standard.</p>

<p>In particular, this test consists of the <i>'Example-004'</i> executable file, starting uniquely from the <i>'main.cpp'</i> C++ source file (in the <i><code>'src'</code></i> folder) without using other dependencies.<p>Several methods for building this test are provided, and their building infrastructure is saved in the following folders:<p><ul>
...
<p><table border=1 width=100%><tr><td><p><b>VERY IMPORTANT:</b><p>It is clear that this test can be built and run ONLY if your C++ compiler is a C++11-compliant compiler. The most recent versions of the compilers in the current literature are C++11-compliant.<p></td></tr></table></p><p><hr><p>
...
<p>As mentioned above, the <i>'Example-004'</i> executable file is created. For instance, this test is executed by running:</p><pre>./Example-004</pre>
