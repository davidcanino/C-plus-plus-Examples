...
<p>This test about the use of the C++ programming language validates the use of the bitwise and <i><code>&</code></i> operator between the result of invoking the same function several times with two different arguments.</p>
<p><hr></p>

<!--- Test Files Organization --->
<h4>Test Files Organization</h4>
<p>This test consists of the <i>'Example-200'</i> executable file, starting uniquely from the <i>'main.cpp'</i> C++ source file (in the <i><code>'src'</code></i> folder) without using other dependencies.</p>
...
<p>
	As mentioned above, the <i>'Example-200'</i> executable file is created. For instance, this test is executed by running:
</p>
<pre>./Example-200</pre>
<p>
