...
int main(void)
{
    ...
    cout << "\t-) the minimum value for an object of \'int\' type is " << INT_MIN << " (see the INT_MIN macro);" << endl;
    cout << "\t-) the maximum value for an object of \'int\' type is " << INT_MAX << " (see the INT_MAX macro)." << endl << endl;
