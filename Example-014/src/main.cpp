/**********************************************************************************************************************************************************************************
 * Examples in the C++ language (the 'Example-014' Test).
 *
 ...
 *
 * main.cpp - the C++ source file, implementing the main function for the 'Example-014' Test.
 **********************************************************************************************************************************************************************************/
...
/// The main function for the <i>'Example-014'</i> Test.
int main(void)
{
    /* This is the 'Example-014' Test, where the properties of the 'char' C++ built-in type are analyzed. */
    cout << endl << "\tThis is the \'Example-014\' Test in the C++ language." << endl;
    cout << "\t=======================================================================================================================================================" << endl << endl;
    cout.flush();
    
    /* TASK #1 - retrieving several properties of the 'char' C++ built-in type! */
    cout << "\tThe \'char\' C++ built-in type:" << endl << endl;
    ...
    cout << "\t-) has " << (int)std::numeric_limits<char>::min() << " as the minimum finite value, representable as a \'char\' value;" << endl;
    ...
    if(std::numeric_limits<char>::has_infinity) cout << "\t-) represents the \'infinity\' value as " << std::numeric_limits<char>::infinity() << ";" << endl << endl;
    else cout << "\t-) does not represent the \'infinity\' value;" << endl << endl;
    cout.flush();
    
    /* TASK #2 - continuing our analysis! */
    if(std::numeric_limits<char>::is_iec559) cout << "\t-) fulfills the requirements of the IEC 559 (IEEE 754) standard;" << endl;
    ...
    if(std::numeric_limits<char>::has_denorm) cout << "\t-) represents subnorm values;" << endl;
    ...
    cout << "\t-) has " << (int)std::numeric_limits<char>::epsilon() << " as the machine epsilon, i.e., the difference between 1.0 and the next value, representable as a \'char\' value;" << endl;
    cout << "\t-) has " << (int)std::numeric_limits<char>::round_error() << " as the maximum rounding error;" << endl;
    cout << "\t-) has " << (int)std::numeric_limits<char>::denorm_min() << " as the minimum positive subnormal \'char\' value;" << endl;
    ...
    switch (std::numeric_limits<char>::round_style)
    {
        case round_toward_zero:
            ...
            cout << "\t-) exploits the \'round toward zero\' policy for rounding not completely \'char\' values." << endl << endl;
            cout.flush();
            break;
            
        case round_to_nearest:
            
            cout << "\t-) exploits the \'round to nearest\' policy for rounding not completely \'char\' values." << endl << endl;
            cout.flush();
            break;

        case round_toward_infinity:
            
            cout << "\t-) exploits the \'round to the positive infinity\' policy for rounding not completely \'char\' values." << endl << endl;
            cout.flush();
            break;
            
        case round_toward_neg_infinity:
            
            cout << "\t-) exploits the \'round to the negative infinity\' policy for rounding not completely \'char\' values." << endl << endl;
            cout.flush();
            break;
            
        default:
            
            cout << "\t-) does not exploit a policy for rounding not completely \'char\' values." << endl << endl;
            cout.flush();
            break;
    }
    ...
    cout << "\t-) the number of bits in a \'char\' value is " << CHAR_BIT << " (see the CHAR_BIT macro);" << endl;
    cout << "\t-) the minimum value for an object of \'char\' type is " << (int)CHAR_MIN << " (see the CHAR_MIN macro);" << endl;
    cout << "\t-) the minimum value for an object of \'char\' type is " << (int)SCHAR_MIN << " (see the SCHAR_MIN macro);" << endl;
    cout << "\t-) the maximum value for an object of \'char\' type is " << (int)CHAR_MAX << " (see the CHAR_MAX macro);" << endl;
    cout << "\t-) the maximum value for an object of \'char\' type is " << (int)SCHAR_MAX << " (see the SCHAR_MAX macro)." << endl << endl;
