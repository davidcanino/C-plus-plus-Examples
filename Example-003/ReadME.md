...
<p>This basic test about the use of the C++ programming language tries to recognize what shell parameters are passed as arguments of the program, and exports their number and content on the standard output. These basic operations may be useful for the debugging purposes.</p>
...
<p>As mentioned above, the <i>'Example-003'</i> executable file is created. For instance, this test is executed by running:</p><pre>./Example-003</pre>
